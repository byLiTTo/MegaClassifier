...
#########################################################################################
#%% Constantes, importaciones, entorno
...
import tenosorflow.compat.v1 as tf
...
class ImagePathUtils:
    ...
    def find_image_files(strings):
        ...
        nomres busca a partir de las extensiones incluidas en image_extension.
        """
    ...
    class TFDetector:
        ...
        def generate_detections_one_image(self, image, image_id,
            ...
            try:
                ...
                result['deteccion_max_conf'] = truncate_float(float(max_detection_conf),
                                                            precision=TFDetector.CONF_DIGITS)
                result['detecciones'] = detections_cur_image
...
def load_and_run_detector(model_file, image_file_names, output_dir,
    ...
    print('De media, para esta iamgen,')
